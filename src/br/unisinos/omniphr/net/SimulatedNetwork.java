...
/**
 * In-process simulated P2P network: nodes grouped into subnetworks, each
 * subnetwork served by routing overlays, and subnetworks interconnected by
 * backbone routers. Link latencies are simulated: a hop inside a subnetwork
...
public class SimulatedNetwork {
    ...
    /** Simulated one-hop latency bounds, in milliseconds. */
    ...
    /**
     * Simulated latency of a single hop between two nodes. Crossing
